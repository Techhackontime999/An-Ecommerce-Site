...
ALL_SETTINGS = [
    ...
    _S('hero_video_light', 'Hero video — light mode', 'homepage', 'text', '',
       'URL or path to the light-mode hero video, e.g. /media/hero/light.mp4 (MP4/WebM). Leave empty to fall back to the other theme or the static hero.'),
    _S('hero_video_dark', 'Hero video — dark mode', 'homepage', 'text', '',
       'URL or path to the dark-mode hero video, e.g. /media/hero/dark.mp4 (MP4/WebM). Leave empty to fall back to the other theme or the static hero.'),
